    ...
    <>
      ...
      <Card className="p-0" data-testid="profile-details-info">
        <div className="p-4" data-testid="profile-name">
          <p className="label-md text-secondary" data-testid="profile-name-label">{t.name}</p>
        ...
        <div className="p-4" data-testid="profile-email">
          <p className="label-md text-secondary" data-testid="profile-email-label">{t.email}</p>
        ...
        <div className="p-4" data-testid="profile-phone">
          <p className="label-md text-secondary" data-testid="profile-phone-label">{t.phone}</p>
          <p className="label-lg text-primary" data-testid="profile-phone-value">{user.phone}</p>
        </div>
      </Card>
      {showForm && (
        <Modal
          heading={t.editProfile}
