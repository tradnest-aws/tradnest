...
export async function retrieveCart(id?: string) {
  ...
  return await sdk.client
    .fetch<HttpTypes.StoreCartResponse>(`/store/carts/${cartId}`, {
      ...
      query: {
        fields:
          "*items, *region, *items.product, *items.product.vendor, *items.variant, +items.thumbnail, +items.metadata, *promotions, *company, *company.approval_settings, *customer, *approvals, +completed_at, *approval_status",
      },
      headers,
      next,
    })
